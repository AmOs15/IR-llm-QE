#!/usr/bin/env python3
"""
Baseline Search and Evaluation for MIRACL Japanese

Performs BM25 search on dev queries without any query modification,
...
def search_queries(
    ...
    """
    Perform BM25 search for all queries.
...
def main():
    """Main function to run baseline search and evaluation."""
    print("=" * 60)
    print("Baseline Search and Evaluation")
    print("=" * 60)
